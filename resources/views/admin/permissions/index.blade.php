			...
			<table class=" table table-bordered table-striped table-hover datatable datatable-Permission">
				...
				<tbody>
					...
					<tr data-entry-id="{{ $permission->id }}">
						...
						<td>
							<a class="btn btn-outline-success" href="{{ route('admin.permissions.show', $permission->id) }}">
								{{ 'View' }}
							</a>

							<a class="btn btn-outline-success" href="{{ route('admin.permissions.edit', $permission->id) }}">
								{{ 'Edit' }}
							</a>
